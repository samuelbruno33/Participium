...
| STK-03 | Admin                | Platform-level manager with extended privileges.                          | Manage users, oversee system activity, enforce policies.             | System security, data integrity, moderation workload.             | Medium            |
...
| STK-05 | System Administrator | Technical operator responsible for infrastructure and system maintenance. | Maintain infrastructure, ensure deployment, backups, security, and system performance, access analytics. | System reliability, uptime, scalability, security threats, disaster recovery readiness, reliability of analytics.    | Medium            |
...
| FR-5.1   |The system shall provide a report detail view to users including description, photos and updates|Critical|US-04     |    |
...
| NFR-07 | Maintenability | The system shall allow the porting to a mobile application within 1000 ph of development                                                                                | Effort (person x hour)              | Analysis     | Important | **Assumption** that in the future may be desirable to develop a mobile application |
